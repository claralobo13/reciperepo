...
public class RecipeRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if(itemViewType == RECIPE_TYPE){
            RequestOptions requestOptions = new RequestOptions().placeholder(R.drawable.wine);
            ...
            ((RecipeViewHolder)viewHolder).label.setText(mRecipes.get(i).getLabel());
            ((RecipeViewHolder)viewHolder).label.setText(mRecipes.get(i).getLabel());
            ((RecipeViewHolder)viewHolder).label.setText(mRecipes.get(i).getLabel());
        }
            ...
            Uri path = Uri.parse("android.resource://com.example.recipeapp/drawable/" + mRecipes.get(i).getImage());
            Glide.with(viewHolder.itemView.getContext())
                    .setDefaultRequestOptions(requestOptions)
                    .load(path)
                    .into(((CategoryViewHolder)viewHolder).categoryImage);
            ((CategoryViewHolder)viewHolder).categoryTitle.setText(mRecipes.get(i).getLabel());
    ...
    public int getItemViewType(int position) {
        if(mRecipes.get(position).getFoodId().equals("LOADING...")){
            ...
            return EXHAUSTED_TYPE;
                ...
                && position != 0
                && !mRecipes.get(position).getLabel().equals("EXHAUSTED...")){
            return LOADING_TYPE;
        }
        else{
            return RECIPE_TYPE;
    ...
    public void displaySearchCategories(){
        ...
        for(int i = 0; i< Constants.DEFAULT_SEARCH_CATEGORIES.length; i++){
            ...
            recipe.setFoodId(Constants.DEFAULT_SEARCH_CATEGORIES[i]);
